...
describe("responsive time axes",()=>{
  ...
  it("uses month/year for longer and monthly ranges",()=>{const long=["2025-12-01","2026-03-01"];expect(compactTimeLabel(long[0],long)).toBe("12/2025");expect(compactTimeLabel("2026-03-01",long,"monthly")).toBe("3/2026")});
